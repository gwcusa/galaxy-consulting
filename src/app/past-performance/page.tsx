...
export const metadata: Metadata = {
  ...
  description:
    'Galaxy Consulting past performance with the Department of Veterans Affairs, US Marine Forces Pacific, Department of the Navy, and Maryland state agencies.',
};
...
const contracts = [
  {
    ...
    scope: [
      'Managed multi-conference room facility for VHA EES and National Conference Center',
      'Provided meeting and conference scheduling assistance for VHA EES meetings',
      'Configured and set-up conference meeting rooms, conference bridges, and audio-visual support',
      'Assisted conference meeting participants and coordinated support services from third-party vendors',
    ],
  ...
  },
  {
    ...
    tagColor: 'bg-blue-accent/10 text-blue-bright',
    scope: [
      'Delivered Cisco model #8841 IP phones',
      'Delivered Cisco conference phone accessories and installation materials',
      'Delivered Cisco wired microphone kit',
      'Delivered Cisco wall mounting kit',
    ],
  ...
  },
  {
    ...
    scope: [
      'Provided 250 Avaya 9408 Digital Telephones and Digital Circuit Cards',
      'Coordinated with multiple distribution hubs to consolidate equipment from multiple sources',
      'Prepared packaging and shipping documents to meet Department of Defense shipping requirements',
    ],
  ...
  },
  {
    ...
    scope: [
      ...
      'Maryland Executive Office of the Governor',
      'Maryland Department of Housing and Community Development (DHCD)',
      'Maryland Public Television',
      'Maryland Department of Human Services',
      'Maryland Clifton T. Perkins Hospital Center',
      'Maryland Infectious Disease Prevention and Health Services Bureau',
      ...
      <section className="bg-galaxy py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p
            ...
            style={{ fontFamily: 'var(--font-inter)' }}
          >
            A proven track record with federal and state government customers — delivering technology
            solutions and professional services that meet mission requirements on time and on budget.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:divide-x lg:divide-blue-accent/20">
            {agencies.map((a) => (
              <div key={a.abbr} className="flex flex-col items-center text-center py-2">
                ...
                <span
                  className="text-xs text-silver/60 mt-1 leading-snug max-w-[120px]"
                  style={{ fontFamily: 'var(--font-inter)' }}
                >
                  {a.name}
                </span>
                <span
                  className="text-xs text-blue-bright mt-1"
                  style={{ fontFamily: 'var(--font-inter)' }}
                >
                  {a.count}
                </span>
          ...
          <div className="space-y-6">
            {contracts.map((c) => (
              <div
                ...
                className={`bg-white rounded-xl border ${c.color} overflow-hidden card-hover`}
              >
                {/* Contract header */}
                  ...
                  <div className="flex flex-wrap items-start gap-3 justify-between">
                    <div>
                      <div className="flex flex-wrap items-center gap-2 mb-1.5">
                        <span
                          className={`text-xs font-bold px-2.5 py-1 rounded-full ${c.tagColor}`}
                          style={{ fontFamily: 'var(--font-inter)' }}
                        >
                          {c.type}
                        </span>
                        <span
                          className="text-xs text-silver/50 font-mono"
                          style={{ fontFamily: 'var(--font-inter)' }}
                        >
                          NAICS {c.naics}
                        </span>
                      ...
                      <p
                        className="text-sm text-silver mt-0.5"
                        style={{ fontFamily: 'var(--font-inter)' }}
                      >
                        {c.subCustomer}
                      </p>
                    ...
                    <div className="text-right flex-shrink-0">
                      <div
                        className="text-xs text-silver/50 font-mono mb-1"
                        style={{ fontFamily: 'var(--font-inter)' }}
                      >
                        {c.contractNumber}
                      </div>
                      <div className="flex items-center gap-1.5 text-xs text-silver/60 justify-end" style={{ fontFamily: 'var(--font-inter)' }}>
                        <MapPin size={11} />
                        {c.location}
                      </div>
                    </div>
                ...
                <div className="p-6">
                  ...
                  <div className="bg-navy/5 rounded-lg p-4 border border-navy/10">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <span
                          className="text-xs font-semibold text-navy uppercase tracking-wider block mb-1"
                          style={{ fontFamily: 'var(--font-inter)' }}
                        >
                          Relevance
                        </span>
                        <p
                          className="text-xs text-silver leading-relaxed"
                          style={{ fontFamily: 'var(--font-inter)' }}
                        >
                          {c.relevance}
                        </p>
      ...
      <section className="py-16 bg-galaxy">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2
            ...
            style={{ fontFamily: 'var(--font-barlow)' }}
          >
            Add Your Agency to Our Portfolio
          </h2>
          <p className="text-silver/70 text-sm mb-8" style={{ fontFamily: 'var(--font-inter)' }}>
            Contact us to discuss how our experience can serve your mission.
          </p>
